...
<body class="bg-gray-100 p-6">
        ...
        <div id="formModal" class="flex items-center justify-center bg-gray-800 bg-opacity-50 fixed inset-0">
            <div class="bg-white p-6 rounded-lg shadow-lg w-96">
                ...
                <form action="{{ route('Mahasiswa.update', $mahasiswa['npm']) }}" method="post">
                    ...
                    <input type="text" name="email" value="{{$mahasiswa['email']}}" id="editemail" class="border w-full p-2 mb-2 rounded">

                    <label class="block">Id User</label>
                    <input type="text" name="id_user" value="{{$mahasiswa['id_user']}}" id="editiduser" class="border w-full p-2 mb-2 rounded">

                    <label class="block">Nama Kelas</label>
                    <input type="text" name="nama_kelas" value="{{$mahasiswa['nama_kelas']}}" id="editkelas" class="border w-full p-2 mb-2 rounded">

                    <label class="block">Username</label>
                    <input type="text" name="username" value="{{$mahasiswa['username']}}" id="editusername" class="border w-full p-2 mb-2 rounded">

                    <label class="block">Password</label>
                    <input type="text" name="password" value="{{$mahasiswa['password']}}" id="editpassword" class="border w-full p-2 mb-2 rounded">
    ...
    <div id="successModal" class="hidden fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center">
        <div class="bg-white p-6 rounded-lg shadow-lg w-96 text-center">
            ...
            <a href="Mahasiswa" onclick="closeSuccessModal()" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">OK<a>
        </div>
    </div>
