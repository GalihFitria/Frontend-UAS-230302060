    ...
    <div id="formModal" class="flex items-center justify-center bg-gray-800 bg-opacity-50 fixed inset-0">
        <div class="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <form action="{{route('Mahasiswa.store')}}" method="post">
                ...
                <input type="text" name="npm" class="border w-full p-2 mb-2 rounded">

                <label class="block">Nama Mahasiswa</label>
                <input type="text" name="nama_mahasiswa" class="border w-full p-2 mb-2 rounded">

                <label class="block">Email</label>
                <input type="text" name="email" class="border w-full p-2 mb-2 rounded">

                <label class="block">Id User</label>
                <input type="text" name="id_user" class="border w-full p-2 mb-2 rounded">

                <label class="block">Nama Kelas</label>
                <input type="text" name="nama_kelas" class="border w-full p-2 mb-2 rounded">

                <label class="block">Username</label>
                <input type="text" name="username" class="border w-full p-2 mb-2 rounded">

                <label class="block">Password</label>
                <input type="text" name="password" class="border w-full p-2 mb-2 rounded">
